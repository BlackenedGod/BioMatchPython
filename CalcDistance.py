...
class CalcDistance:
    ...
    def __init__(self):
        self.focalLength = ""
        self.sensorHeigth = ""
        self.distanceToObject = ""

    def calcDistance(self, focalLength, sensorHeigth, distanceToObject):
        image = cv2.imread('TestImg/picTac2015-05-20 18:18:03.489000.png')
        ...
        (rowImage, colImage, _) = image.shape
